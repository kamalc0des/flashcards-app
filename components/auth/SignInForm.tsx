    ...
    <div className="min-h-dvh bg-zinc-950 text-white flex flex-col lg:flex-row">
      ...
      <div className="flex flex-col items-center justify-center lg:w-1/2 px-8 py-12 lg:px-16">
        <div className="w-full max-w-sm">
          <div className="mb-8">
            <h2 className="text-2xl font-bold tracking-tight mb-1">Connexion</h2>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-zinc-700 bg-zinc-900 text-zinc-200 font-medium text-sm hover:bg-zinc-800 active:scale-95 transition-all"
          >
